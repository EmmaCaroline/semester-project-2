...
/*function createSpecificListings(listing) {
  ...
  if (Array.isArray(listing) && listing.length >= 3) {
    ...
    const firstImageLink = document.createElement("div");
    ...
    const secondImageLink = document.createElement("div");
    ...
    secondImageText.textContent = secondPost.title; // Set title text
    secondImageLink.appendChild(secondImageText);

    // Create the third image container
    const thirdImageLink = document.createElement("div");
    ...
    wrapperDiv.appendChild(secondImageLink);
    wrapperDiv.appendChild(thirdImageLink);
